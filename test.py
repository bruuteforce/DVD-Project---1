...
if not os.path.exists('E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp'):
    os.mkdir('E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp')
    os.mkdir('E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp\\outputs')

    columns=['v(sd1)','power?','vgen','va','vb']
    source_file = 'E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\AandBn.ckt'
    destination_file = f'E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp\\AandBn.ckt'
    # string_to_replace1 = '.PARAM Wmin=45n'
    # new_string1 = f'.PARAM Wmin=45n*{i}'
    string_to_replace2 = 'AandBn.txt'
    new_string2 = f'E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp\\outputs\\AandBn.txt'
    copy_and_edit_file(source_file, destination_file, string_to_replace2, new_string2)
    os.system(f'ngspice_con -b E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp\\AandBn.ckt')
    parse_file(f'E:\DVD\project_1\DVD-Project---1\STACKED_MOS_files\\temp\\outputs\\AandBn.txt',"v(sd1)",columns)
